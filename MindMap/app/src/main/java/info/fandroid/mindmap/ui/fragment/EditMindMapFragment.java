 ...
 */
public class EditMindMapFragment  extends Fragment {

    private AppCompatActivity activity;


    OnEditFragmentListener mCallback;
    ...
    public interface OnEditFragmentListener {
        void onBackFromEdit(ModelMap model);
    }
    ...
    private void setUI(View rootView) {
                            ...
                            public void run() {
                                ...
                                dialog.setOnChooseSubjectListener(new ChooseSubjectDialogFragment.ChooseSubjectDialogListener() {
                                    ...
                                    public void onSubjectDialogPositiveClick(ModelMap.Subject subject) {
                                        ...
                                        EditMindMapFragment.this.mSubject = subject;
                                    }
                                });
                            }
                        }, 50);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (EditMindMapFragment.this.mSubject != null) {
                    model.setSubject(EditMindMapFragment.this.mSubject);
                }
                mDbManager.update().map().full(model.getId(), model);
    ...
    public void setOnFragmentListener(OnEditFragmentListener mCallback) {
